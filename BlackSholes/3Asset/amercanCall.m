...
aa=0.5*dt*(sigma_*sigma_*(1:N-2).*(1:N-2)-(mu_)*(1:N-2))';
bb=1-dt*(sigma_*sigma_*(1:N-2).*(1:N-2)+r)';
cc=0.5*dt*(sigma_*sigma_*(1:N-2).*(1:N-2)+(mu_)*(1:N-2))';
